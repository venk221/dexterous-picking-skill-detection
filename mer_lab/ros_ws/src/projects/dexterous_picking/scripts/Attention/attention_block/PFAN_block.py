...
class PFAN_SpatialAttention(nn.Module):
    def __init__(self, in_channels, kernel_size=9):
        super(PFAN_SpatialAttention, self).__init__()
...
class PFAN_ChannelwiseAttention(nn.Module):
    def __init__(self, in_channels):
        super(PFAN_ChannelwiseAttention, self).__init__()
