...
class U2net(object):
    ...
    def save_output(self, image_name, pred, d_dir, input_image):
        ...
        contours, _ = cv2.findContours(gray_resized_image, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)
    ...
    def process_image(self, image):
        ...
        # # Merge the grayscale channels with the alpha channel to form BGRA grayscale image
        # image = cv2.merge((gray_image, gray_image, gray_image, a))
        ...
        # model_dir = os.path.join(os.getcwd(), 'saved_models', 'attu2netoutside', model_name + '.pth')
    ...
    def callback_image(self, msg):
        ...
        # print("callback image shape", image.shape)
