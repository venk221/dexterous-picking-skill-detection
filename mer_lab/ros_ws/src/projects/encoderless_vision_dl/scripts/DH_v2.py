...
class Kinematics():
    ...
    def __init__(self, joint_angles):
        ...
        DH_params = {"joint1": [0,      0.333,             0,   joint_angles[0]],
                     ...
                     "joint7": [0.088,      0,   (math.pi/2),   joint_angles[6]+(math.pi/4)],
                     "joint8": [0.1,      0.1070,   0,   0]}

        self.DH_params = DH_params

    def forward(self):
        joints = ["joint1", "joint2", "joint3",
                  "joint4", "joint5", "joint6", "joint7", "joint8"]
...
if __name__ == '__main__':
    ...
    # print(np.around(ht[6], decimals=3))  
    # ht[6][1][3] += 1
    # print(np.around(ht[6], decimals=3))    

    # print(np.around(forward.forward()[6], decimals=3))
