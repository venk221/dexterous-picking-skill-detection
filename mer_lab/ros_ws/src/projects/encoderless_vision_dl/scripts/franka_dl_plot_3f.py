...
def main(args):
    ...
    err_data = []
    # read feature error
    # with open('/home/jc-merlab/Pictures/Dl_Exps/dl_vs/servoing/exps/5/err.csv','r') as csvfile:
    ...
    ax1.grid()
    ax1.set_xticks(np.arange(0, len(err_norm), 20))
    ...
    ax2.legend(['cx2','cy2','cx3','cy3', 'cx4', 'cy4'],loc='upper center',
    ...
    # plt.savefig('/home/jc-merlab/Pictures/Dl_Exps/dl_vs/servoing/exps/5/feature_error.png', dpi=300)
    # Image.open('/home/jc-merlab/Pictures/Dl_Exps/dl_vs/servoing/exps/5/feature_error.png').convert("RGB").save('/home/jc-merlab/Pictures/Dl_Exps/dl_vs/servoing/exps/5/feature_error.jpg','JPEG')
    ...
    # with open('/home/jc-merlab/Pictures/Dl_Exps/dl_vs/servoing/exps/5/modelerror.csv','r') as csvfile:
    ...
    # with open('/home/jc-merlab/Pictures/Dl_Exps/dl_vs/servoing/exps/5/j1vel.csv','r') as csvfile:
    with open('j1vel.csv','r') as csvfile:
        plots = csv.reader(csvfile, delimiter = ',')
        for row in plots:
            j1_vel.append(row)
    
    # with open('/home/jc-merlab/Pictures/Dl_Exps/dl_vs/servoing/exps/5/j2vel.csv','r') as csvfile:
    ...
    ax1.grid()
    ax1.set_xticks(np.arange(0, len(model_error), 25))
    ...
    # plt.savefig('/home/jc-merlab/Pictures/Dl_Exps/dl_vs/servoing/exps/5/plot.png', dpi=300)
    # Image.open('/home/jc-merlab/Pictures/Dl_Exps/dl_vs/servoing/exps/5/plot.png').convert("RGB").save('/home/jc-merlab/Pictures/Dl_Exps/dl_vs/servoing/exps/5/plot.jpg','JPEG')
