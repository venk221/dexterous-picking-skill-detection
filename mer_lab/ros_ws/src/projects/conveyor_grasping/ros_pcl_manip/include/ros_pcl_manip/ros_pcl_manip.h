...
// TODO: Include it later
// #include <ros_pcl_manip/AddGaussianNoise.h>
...
typedef pcl::octree::OctreePointCloudPointVector<PointType> OctreeType;
...
typedef pcl::StatisticalOutlierRemoval<PointType> StatisticalOutlierRemovalType;
...
public:
  ...
  NormalCloudPtr computeNormals(CloudConstPtr in_cloud, int k=10, geometry_msgs::Point view=geometry_msgs::Point());
  ...
  bool filter_service(ros_pcl_manip::Filter::Request& req,
  ...
  bool norm_service(ros_pcl_manip::NormalEst::Request& req,
		    ros_pcl_manip::NormalEst::Response& res);
  bool outlier_removal_service(ros_pcl_manip::OutlierRemoval::Request& req,
			       ros_pcl_manip::OutlierRemoval::Response& res);
  bool voxelize_service(ros_pcl_manip::Voxelize::Request& req,
...
private:
  ...
  ros::ServiceServer _norm_server;
  ros::ServiceServer _outlier_removal_server;
  ros::ServiceServer _voxelize_server;
