...
#include "encoderless_vs/dream_kp.h"
...
int main(int argc, char **argv){
    ...
    ros::service::waitForService("dream_kp_service_response", 1000);  
    ...
    ros::ServiceClient kp_client = n.serviceClient<encoderless_vs::dream_kp>("dream_kp_service_response");
    ...
    encoderless_vs::dream_kp cp_msg;
...
// command small displacements around initial position
    ...
    for(int i = 0; i<no_of_features; i++){
        ...
        cur_features[i] = cp_msg.response.pix.data.at(i);
