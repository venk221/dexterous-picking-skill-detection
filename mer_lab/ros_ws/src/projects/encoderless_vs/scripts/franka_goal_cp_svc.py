...
from encoderless_vs.srv import franka_cp_goal, franka_cp_goalResponse, franka_bin_img, franka_bin_imgResponse
...
def franka_control_points_service(data):  
  ...
  # cv2.imwrite("skeleton_goal_final.jpg", skeleton)
