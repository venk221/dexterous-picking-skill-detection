...
class DreamInferenceROS:
    def __init__(self, args, single_frame_mode=True, compute_2d_to_3d_transform=False):
        ...
        self.dream_kp_service = rospy.Service("dream_kp_service_response", dream_kp, self.dream_kp_service)
    ...
    def dream_kp_service(self, msg):
        ...
        cv2.circle(img, (np.int64(key_points[-1][0]), np.int64(key_points[-1][1])), 10, (255, 0, 0), -1)
        ...
        # return dream_kpResponse(cp_resp)
