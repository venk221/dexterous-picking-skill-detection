...
roslaunch encoderless_vs franka_goal_dream.launch i:=/home/merlab/DREAM/trained_models/panda_dream_resnet_h.pth b:=panda_link0
...
mv ~/.ros/dream_features.yaml ~/mer_lab/ros_ws/src/projects/encoderless_vs/config/
