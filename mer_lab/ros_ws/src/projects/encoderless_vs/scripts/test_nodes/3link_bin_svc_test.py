...
from encoderless_vs.srv import three_link_bin_test, three_link_bin_testResponse
...
def binary_image_service(msg):
 ...
 # converting to hsv
  ...
  return three_link_bin_testResponse(binary_image, current_ros_image)
...
def main(args):  
  ...
  bin_test_service = rospy.Service("binary_image_output", three_link_bin_test, binary_image_service )
