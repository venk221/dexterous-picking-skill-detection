...
def talker():    
    pub1 = rospy.Publisher('/3linkbot/joint1_velocity_controller/command', Float64, queue_size=10)
    pub2 = rospy.Publisher('/3linkbot/joint2_velocity_controller/command', Float64, queue_size=10)
    pub3 = rospy.Publisher('/3linkbot/joint3_velocity_controller/command', Float64, queue_size=10)
