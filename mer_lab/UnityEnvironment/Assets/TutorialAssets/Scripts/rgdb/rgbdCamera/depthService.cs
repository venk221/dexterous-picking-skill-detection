...
public class depthService : MonoBehaviour
{
    ...
    [SerializeField]
    string rosServiceName = "/ur3_moveit/getdepthmap";

    // The game object
    public Camera ImageCamera;
    private string FrameId = "unity_camera/depth_frame";
    ...
    void Start()
    {
        ...
        ros.ImplementService<GetDepthMapRequest,GetDepthMapResponse>(rosServiceName, CallBack);
    ...
    private GetDepthMapResponse CallBack(GetDepthMapRequest request)
    {   
        Debug.Log("Received Depth Map Request");
        bool supportsAntialiasing = true;
        bool needsRescale = false;
        var depth = 24;
        var format = RenderTextureFormat.Default;
        // var format = RenderTextureFormat.Depth;
