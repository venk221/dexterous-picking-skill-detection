...
class U2net(object):
    ...
    def process_image(self, image):
        ...
        model_name = 'attu2netoutsidergb_bce_itr_2262_train_4.491092_tar_0.628792'
        ...
        model_dir = os.path.join(self.pkgdir, 'scripts', 'Attention', 'saved_models', 'attu2netoutside', 'RGBD', 'Model_6_LB', model_name + '.pth')
